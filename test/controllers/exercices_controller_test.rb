...
class ExercicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exercice" do
    assert_difference("Exercice.count") do
      post exercices_url, params: { exercice: { courses_id: @exercice.courses_id, name: @exercice.name, published: @exercice.published, slug: @exercice.slug, user_id: @exercice.user_id } }
    end
  ...
  test "should update exercice" do
    patch exercice_url(@exercice), params: { exercice: { courses_id: @exercice.courses_id, name: @exercice.name, published: @exercice.published, slug: @exercice.slug, user_id: @exercice.user_id } }
